(function() {
    ...
    for (var n = 0; n < globalNav.length; n++) {
        ...
        globalNav[n].addEventListener("click", function(e) {
            ...
            var openNav = document.querySelector('.c-global-navigation__list-item--active');
            if (openNav) {
                var navLink = openNav.querySelector('.a-menu-link');
                openNav.classList.remove('c-global-navigation__list-item--active');
                navLink.setAttribute("aria-expanded", "false");
            ...
            e.currentTarget.classList.toggle('c-global-navigation__list-item--active');
